...
namespace MainApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var firstList = new List<string> { "abc", "a", "b", "98", "GC", "Olya", "Artsem", "blablabla" };

            var secondList = new List<string> {  "new", "this", "Olya", "Artsem", "blablabla" };

            var commonItems = CommonElements.GetCommonElements(firstList, secondList);
